...
# from doubleMotorController import DoubleMotorController
import numpy as np
...
class ImpedanceController:
    ...
    def __init__(self, motor: FilteredMotorController, trajectory_handler: SineTrajectoryHandler, duration: float, Kp=1.0, Kd=0.1, Ki=0.01, Kf=0.5):
        self.motor = motor
    ...
    def run(self):
        ...
        while time.time() - start_time < self.duration:
            ...
            self.motor.set_input_torque(adjusted_torque)
